...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/camelv/ftp/list">FTP列表</a></li>
		<li class="active"><a href="${ctx}/camelv/ftp/form?id=${camelvFtp.id}">FTP${not empty camelvFtp.id?'修改':'添加'}</a></li>
	</ul><br/>
	
	<form:form id="inputForm" modelAttribute="camelvFtp" action="${ctx}/camelv/ftp/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="type">
					<form:option value="ftp">FTP</form:option>
					<form:option value="sftp">SFTP</form:option>
				</form:select>
			</div>
		</div>
		<div class="control-group">
