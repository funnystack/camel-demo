	...
	initWorkForNode:function(){
		...
		this.$workArea.delegate(".ico","mousedown",{inthis:this},function(e){
			...
			document.onmousemove=function(e){
				...
				isMove=true;
				var timer = null;
				var left = 0,top=0,newLeft,newTop;
				//biao:添加平滑移动
				Dom.hide();
				timer = setInterval(function() {
					if(isMove){
						newLeft = X + This.$workArea[0].parentNode.scrollLeft - t.left;
						newTop = Y + This.$workArea[0].parentNode.scrollTop - t.top;
