...
public final class MyServer {
    ...
    public static void main(String[] args) throws Exception {
        Main main = new Main();
        main.addRouteBuilder(new ServerRouteBuilder());
        main.bind("myEncoder", new EncoderFactory());
        main.bind("myDecoder", new DecoderFactory());
        main.run(args);
    }

    private static class ServerRouteBuilder extends RouteBuilder {
